...
export function GithubIcon(props: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d='M12 2C6.48 2 2 6.58 2 12.24c0 4.52 2.87 8.35 6.84 9.71.5.1.68-.22.68-.49v-1.7c-2.78.62-3.37-1.23-3.37-1.23-.45-1.19-1.11-1.5-1.11-1.5-.91-.64.07-.63.07-.63 1 .07 1.53 1.05 1.53 1.05.9 1.58 2.35 1.12 2.92.86.09-.67.35-1.12.64-1.38-2.22-.26-4.55-1.14-4.55-5.06 0-1.12.39-2.03 1.03-2.75-.1-.26-.45-1.3.1-2.71 0 0 .84-.28 2.75 1.05A9.2 9.2 0 0 1 12 7.14c.85 0 1.7.12 2.5.36 1.91-1.33 2.75-1.05 2.75-1.05.55 1.41.2 2.45.1 2.71.64.72 1.03 1.63 1.03 2.75 0 3.93-2.34 4.8-4.57 5.05.36.32.68.95.68 1.92v2.84c0 .27.18.59.69.49A10.25 10.25 0 0 0 22 12.24C22 6.58 17.52 2 12 2Z' />
    </svg>
  );
}

export function CredlyIcon(props: IconProps) {
  return (
    <svg
      width='24'
      height='24'
    ...
    >
      <path
        d='M12 2.2 20 5v6.1c0 5.1-3.4 8.9-8 10.7-4.6-1.8-8-5.6-8-10.7V5l8-2.8Z'
        fill='currentColor'
      />
      <path
        d='M15.8 8.2a4.8 4.8 0 1 0 0 7.6'
        stroke='#1b252b'
        strokeWidth='1.8'
        strokeLinecap='round'
      />
