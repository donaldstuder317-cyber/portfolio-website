      ...
      <div className='mx-auto max-w-[1170px] px-4 sm:px-8 xl:px-0'>
        <div className='relative z-999 aspect-39/20 rounded-3xl'>
          <button
            ...
            className='shadow-video absolute top-1/2 left-1/2 z-10 flex h-27.5 w-27.5 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-linear-to-b from-[#A073EE] to-[#6E25ED]'
          >
            <svg
              width='30'
              height='30'
          ...
          <span className='absolute top-1/2 left-1/2 z-1 block h-32 w-32 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white/[0.02]'></span>
