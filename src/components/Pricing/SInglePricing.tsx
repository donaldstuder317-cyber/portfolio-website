...
const SinglePricing = ({ price }: any) => {
  ...
  return (
    <div className='wow fadeInUp pricing-item-border bg-dark relative z-20 overflow-hidden rounded-3xl px-8 pt-12.5 pb-10 xl:px-10'>
      ...
      <h3 className='text-heading-6 mb-5.5 font-semibold text-white'>
      ...
      <div className='pointer-events-none absolute inset-0 -z-10 overflow-hidden'>
        ...
        <span className='absolute top-0 left-0 -z-1 aspect-370/350 w-full'>
          <Image
